...
declare function groupArrByKey<T extends ObjectType, K extends keyof T>(objectArray: T[], property: K): Record<T[K], T[]>;
/**
...
/********** 내부 함수 **********/
export { addCommas, removeCommas, validateMobileNumber, formatMobileNumber, validateTelNumber, formatTelNumber, groupArrByKey, isEmptyObject };
